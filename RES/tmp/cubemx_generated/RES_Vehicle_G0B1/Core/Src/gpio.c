...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RELAY_1_EN_Pin|RELAY_2_EN_Pin|FAULT_OUT_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : RELAY_1_EN_Pin RELAY_2_EN_Pin START_OUT_Pin FAULT_OUT_Pin */
  GPIO_InitStruct.Pin = RELAY_1_EN_Pin|RELAY_2_EN_Pin|START_OUT_Pin|FAULT_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
