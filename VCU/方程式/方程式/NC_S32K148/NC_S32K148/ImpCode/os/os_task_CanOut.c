...
static void Task_CanOut_20ms(void)
{
	...
	BSP_CAN1_Send_STD((uint32_t)0x21, hcansend1.AMI_Rx);
...
static void Task_CanOut_100ms(void)
{
	BSP_CAN0_Send_STD((uint32_t)0xCFF09EF, hcansend1.cana_motor_cmd3);
}
...
static void Task_CanOut_10ms(void)
{
	BSP_CAN0_Send_STD((uint32_t)0xCFF08EF, hcansend1.cana_motor_cmd);
}
...
static void Task_CanOut_500ms(void)
{
	...
	BSP_CAN0_Send_STD(0xBA, tempdata);
	Task_CanOut_JY60_2(tempdata);
	BSP_CAN0_Send_STD(0xBB, tempdata);
	Task_CanOut_JY60_3(tempdata);
	BSP_CAN0_Send_STD(0xBC, tempdata);
}
