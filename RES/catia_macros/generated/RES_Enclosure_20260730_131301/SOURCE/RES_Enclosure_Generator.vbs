...
' D14 side boss top stays 0.5 mm below the Z68 primary sealing plane.
' The matching 4.6 mm-high cover slot still remains inside the 12.3 mm skirt.
SIDE_SCREW_Z = 60.5
SIDE_BOSS_D = 14
SIDE_BOSS_DEPTH = 12
SIDE_BOSS_NOSE = 0.4
...
Function BuildMainHousing()
  ...
  ' One horizontal through-rib per boss forms two load-spreading arms along
  ' the wall. No symmetric vertical rib is used: at Z62 a 24 mm vertical rib
  ' would rise to Z74 and interfere with the Z68 cover/gasket interface.
  ...
  AddNotes part, "Black high-toughness SLA final: supplier-table M4 x D5 x L8 inserts use D5.1 x 8.5 blind pockets with D5.6 x 0.5 lead-ins. The ten upper side bosses use D24 x T3 horizontal double-arm ribs only, preventing any rib from crossing the Z68 cover/gasket interface; the eight bottom bosses retain four-way ribs. Install only after same-batch D4.9/D5.1/D5.3 coupon validation, using controlled low-temperature press plus toughened epoxy. The inset neck uses a 3 mm die-cut flat silicone gasket with a positive 2.3 mm compression stop. Ten side M4 x 8 screws remain outside the primary seal. Relieved wall cells retain a continuous 2.8 mm nominal waterproof skin and every load path remains full 4 mm."
  HideObject doc, hb
  part.Update
