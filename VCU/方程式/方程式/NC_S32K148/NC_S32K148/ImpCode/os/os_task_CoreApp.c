...
static void Task_CoreApp_SignalConvert(void)
{
	...
	digital_input.io_in = hgetIn2.hin;
	digital_input.adc_in[0] = hgetIn1.ads115_value[0];
	digital_input.adc_in[1] = hgetIn1.ads115_value[1];
	digital_input.adc_in[2] = hgetIn1.ads115_value[2];
	digital_input.adc_in[3] = hgetIn1.adc0_value[0];
	digital_input.adc_in[4] = hgetIn1.adc0_value[1];
	digital_input.adc_in[5] = hgetIn1.adc0_value[2];
	digital_input.adc_in[6] = hgetIn1.adc0_value[3];
}
...
static void Task_CoreApp_SignalSend(void)
{
	...
	//-----------------------------CAN1
	memcpy(hcan_send.ESP_R_00, ESP_R_00, 8);
	...
	//-----------------------------CAN2
	//-----------------------------OUT
	hvcuCtrl1.uln_out = digital_output.OUT;
	hvcuCtrl1.mc3_outh = digital_output.HOUT;
