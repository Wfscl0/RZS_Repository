...
Function BuildMainHousing()
  ...
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, 6
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_BOSS_NOSE, "PAD_FRONT_SIDE_M4_BOSS_NOSES_0_4")

  Set sk = NewSketch(body, pCapFrontOuter, "SK_FRONT_SIDE_M4_NOSE_OPENINGS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, SIDE_BOSS_NOSE, "POCKET_FRONT_SIDE_M4_NOSE_OPENINGS")

  ' Two orthogonal root ribs per boss transfer cover clamp load into the neck
  ' wall. They stop after 5 mm so the inner wiring volume remains clear.
  Set sk = NewSketch(body, pCapFrontOuter, "SK_FRONT_SIDE_M4_RIBS_U")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    DrawRectangleAt f, SIDE_SCREW_Z, x, BOSS_RIB_SPAN, BOSS_RIB_T
  Next
  sk.CloseEdition
  Set feat = AddPadReverse(part, sk, SIDE_RIB_DEPTH, "PAD_FRONT_SIDE_M4_RIBS_U")

  Set sk = NewSketch(body, pCapFrontOuter, "SK_FRONT_SIDE_M4_RIBS_V")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
  ...
  Next
  sk.CloseEdition
  Set feat = AddPadReverse(part, sk, SIDE_RIB_DEPTH, "PAD_FRONT_SIDE_M4_RIBS_V")
  ...
  Set sk = NewSketch(body, pCapRearOuter, "SK_REAR_SIDE_M4_NOSE_OPENINGS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, SIDE_BOSS_NOSE, "POCKET_REAR_SIDE_M4_NOSE_OPENINGS")

  Set sk = NewSketch(body, pCapRearOuter, "SK_REAR_SIDE_M4_RIBS_U")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    DrawRectangleAt f, SIDE_SCREW_Z, x, BOSS_RIB_SPAN, BOSS_RIB_T
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_RIB_DEPTH, "PAD_REAR_SIDE_M4_RIBS_U")

  Set sk = NewSketch(body, pCapRearOuter, "SK_REAR_SIDE_M4_RIBS_V")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    DrawRectangleAt f, SIDE_SCREW_Z, x, BOSS_RIB_T, BOSS_RIB_SPAN
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_RIB_DEPTH, "PAD_REAR_SIDE_M4_RIBS_V")

  Set sk = NewSketch(body, pCapFrontOuter, "SK_FRONT_SIDE_M4_INSERTS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
  ...
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, TOP_INSERT_POCKET_D, "POCKET_FRONT_SIDE_M4_INSERTS_D5_1X8_5")

  Set sk = NewSketch(body, pCapFrontOuter, "SK_FRONT_SIDE_M4_INSERT_LEAD_INS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, INSERT_ENTRY_DEPTH, "POCKET_FRONT_SIDE_M4_D5_6_LEAD_INS")

  Set sk = NewSketch(body, pCapRearOuter, "SK_REAR_SIDE_M4_INSERTS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, INSERT_HOLE_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, TOP_INSERT_POCKET_D, "POCKET_REAR_SIDE_M4_INSERTS_D5_1X8_5")

  Set sk = NewSketch(body, pCapRearOuter, "SK_REAR_SIDE_M4_INSERT_LEAD_INS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z, x, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, INSERT_ENTRY_DEPTH, "POCKET_REAR_SIDE_M4_D5_6_LEAD_INS")
  ...
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, 6
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_BOSS_NOSE, "PAD_RIGHT_SIDE_M4_BOSS_NOSES_0_4")

  Set sk = NewSketch(body, pCapRightOuter, "SK_RIGHT_SIDE_M4_NOSE_OPENINGS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, SIDE_BOSS_NOSE, "POCKET_RIGHT_SIDE_M4_NOSE_OPENINGS")

  Set sk = NewSketch(body, pCapRightOuter, "SK_RIGHT_SIDE_M4_RIBS_U")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    DrawRectangleAt f, i * 50, SIDE_SCREW_Z, BOSS_RIB_SPAN, BOSS_RIB_T
  Next
  sk.CloseEdition
  Set feat = AddPadReverse(part, sk, SIDE_RIB_DEPTH, "PAD_RIGHT_SIDE_M4_RIBS_U")

  Set sk = NewSketch(body, pCapRightOuter, "SK_RIGHT_SIDE_M4_RIBS_V")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    DrawRectangleAt f, i * 50, SIDE_SCREW_Z, BOSS_RIB_T, BOSS_RIB_SPAN
  Next
  sk.CloseEdition
  Set feat = AddPadReverse(part, sk, SIDE_RIB_DEPTH, "PAD_RIGHT_SIDE_M4_RIBS_V")
  ...
  Set sk = NewSketch(body, pCapLeftOuter, "SK_LEFT_SIDE_M4_NOSE_OPENINGS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, SIDE_BOSS_NOSE, "POCKET_LEFT_SIDE_M4_NOSE_OPENINGS")

  Set sk = NewSketch(body, pCapLeftOuter, "SK_LEFT_SIDE_M4_RIBS_U")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    DrawRectangleAt f, i * 50, SIDE_SCREW_Z, BOSS_RIB_SPAN, BOSS_RIB_T
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_RIB_DEPTH, "PAD_LEFT_SIDE_M4_RIBS_U")

  Set sk = NewSketch(body, pCapLeftOuter, "SK_LEFT_SIDE_M4_RIBS_V")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    DrawRectangleAt f, i * 50, SIDE_SCREW_Z, BOSS_RIB_T, BOSS_RIB_SPAN
  Next
  sk.CloseEdition
  Set feat = AddPad(part, sk, SIDE_RIB_DEPTH, "PAD_LEFT_SIDE_M4_RIBS_V")

  Set sk = NewSketch(body, pCapRightOuter, "SK_RIGHT_SIDE_M4_INSERTS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_HOLE_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, TOP_INSERT_POCKET_D, "POCKET_RIGHT_SIDE_M4_INSERTS_D5_1X8_5")

  Set sk = NewSketch(body, pCapRightOuter, "SK_RIGHT_SIDE_M4_INSERT_LEAD_INS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, INSERT_ENTRY_DEPTH, "POCKET_RIGHT_SIDE_M4_D5_6_LEAD_INS")

  Set sk = NewSketch(body, pCapLeftOuter, "SK_LEFT_SIDE_M4_INSERTS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_HOLE_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, TOP_INSERT_POCKET_D, "POCKET_LEFT_SIDE_M4_INSERTS_D5_1X8_5")

  Set sk = NewSketch(body, pCapLeftOuter, "SK_LEFT_SIDE_M4_INSERT_LEAD_INS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z, INSERT_ENTRY_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, INSERT_ENTRY_DEPTH, "POCKET_LEFT_SIDE_M4_D5_6_LEAD_INS")
  ...
  AddNotes part, "Black high-toughness SLA final: supplier-table M4 x D5 x L8 inserts use D5.1 x 8.5 blind pockets with D5.6 x 0.5 lead-ins and four-way D24 x T3 root ribs. Install only after same-batch D4.9/D5.1/D5.3 coupon validation, using controlled low-temperature press plus toughened epoxy. The inset neck uses a 3 mm die-cut flat silicone gasket with a positive 2.3 mm compression stop. Ten side M4 x 8 screws remain outside the primary seal. Relieved wall cells retain a continuous 2.8 mm nominal waterproof skin and every load path remains full 4 mm."
  HideObject doc, hb
  part.Update
...
Function BuildTopCover()
  ...
  ' A D11 x 0.6 local seat leaves 2.4 mm skirt thickness and recovers enough
  ' thread engagement for the purchased M4 x 8 sealing screws.
  ...
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, CAP_SKIRT_T, "POCKET_FRONT_SIDE_M4_SLOT_5_6X4_6")

  Set sk = NewSketch(body, pFrontOuter, "SK_FRONT_M4_O_RING_SEATS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z - BODY_H - TOP_GASKET_COMP_T, x, TOP_SCREW_SEAT_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, TOP_SCREW_SEAT_DEPTH, "POCKET_FRONT_M4_O_RING_SEATS_D11X0_6")
  ...
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, CAP_SKIRT_T, "POCKET_REAR_SIDE_M4_SLOT_5_6X4_6")

  Set sk = NewSketch(body, pRearOuter, "SK_REAR_M4_O_RING_SEATS")
  Set f = sk.OpenEdition()
  For i = 0 To 2
    x = Array(-60, 0, 60)(i)
    f.CreateClosedCircle SIDE_SCREW_Z - BODY_H - TOP_GASKET_COMP_T, x, TOP_SCREW_SEAT_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, TOP_SCREW_SEAT_DEPTH, "POCKET_REAR_M4_O_RING_SEATS_D11X0_6")
  ...
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, CAP_SKIRT_T, "POCKET_RIGHT_SIDE_M4_SLOT_5_6X4_6")

  Set sk = NewSketch(body, pRightOuter, "SK_RIGHT_M4_O_RING_SEATS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z - BODY_H - TOP_GASKET_COMP_T, TOP_SCREW_SEAT_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocketReverse(part, sk, TOP_SCREW_SEAT_DEPTH, "POCKET_RIGHT_M4_O_RING_SEATS_D11X0_6")
  ...
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, CAP_SKIRT_T, "POCKET_LEFT_SIDE_M4_SLOT_5_6X4_6")

  Set sk = NewSketch(body, pLeftOuter, "SK_LEFT_M4_O_RING_SEATS")
  Set f = sk.OpenEdition()
  For i = -1 To 1 Step 2
    f.CreateClosedCircle i * 50, SIDE_SCREW_Z - BODY_H - TOP_GASKET_COMP_T, TOP_SCREW_SEAT_D / 2
  Next
  sk.CloseEdition
  Set feat = AddPocket(part, sk, TOP_SCREW_SEAT_DEPTH, "POCKET_LEFT_M4_O_RING_SEATS_D11X0_6")
  ...
  AddNotes part, "Wrap-around lid with positive compression stop: use the separate 179 x 141 / 171 x 133 x 3 mm soft silicone flat gasket, compressed to 2.3 mm. Ten side M4 x 8 screws sit outside the seal; each head uses the supplied sealing ring in a D11 x 0.6 seat. LED, start and E-stop holes have raised 0.8 mm gasket lands; retain each component's supplied IP gasket."
  HideObject doc, hb
  part.Update
...
Function BuildBatteryCover()
  ...
  ' approximately 4.2 mm nominal brass-thread engagement after seal compression.
  ...
  AddNotes part, "Battery cover has three barriers: an outer 2 x 1.5 mm labyrinth wall in a 3.4 x 2 mm housing groove, the ID100 x CS2.5 O-ring, and eight outside M4 x 8 screws mating to blind inserts. The 3.0 mm general plate plus a local W8 x H2.0 backing ring retains 3.1 mm below the O-ring groove. Each screw has a D11 x 0.4 recessed sealing-ring seat, leaving 2.6 mm nominal local wall and about 4.2 mm nominal thread engagement. Use 1 mm EVA above and below the battery and 1 mm EVA on side contact areas."
  HideObject doc, hb
  part.Update
...
Sub WriteBuildParameters(stream)
  ...
  stream.WriteLine "TOP SCREW O-RING SEATS = D" & TOP_SCREW_SEAT_D & " x " & TOP_SCREW_SEAT_DEPTH & " mm; residual skirt " & CAP_SKIRT_T - TOP_SCREW_SEAT_DEPTH & " mm"
  stream.WriteLine "TOP INSERT BOSS NOSE = " & SIDE_BOSS_NOSE & " mm into the nominal " & RESIN_CLEARANCE & " mm skirt gap"
  stream.WriteLine "TOP M4 X 8 NOMINAL ENGAGEMENT = " & M4_COVER_SCREW_L - (CAP_SKIRT_T - TOP_SCREW_SEAT_DEPTH) - (RESIN_CLEARANCE - SIDE_BOSS_NOSE) - 0.4 & " mm assuming 0.4 mm compressed screw seal"
  stream.WriteLine "TOP SIDE INSERT BOSS / POCKET / BLIND WALL = " & SIDE_BOSS_DEPTH & " / " & TOP_INSERT_POCKET_D & " / " & SIDE_BOSS_DEPTH - TOP_INSERT_POCKET_D & " mm"
  stream.WriteLine "M4 BOSS ROOT RIBS = four-way span " & BOSS_RIB_SPAN & " x thickness " & BOSS_RIB_T & " mm; side depth " & SIDE_RIB_DEPTH & " / bottom height " & BOTTOM_RIB_H & " mm"
  ...
  stream.WriteLine "M4 INSERT LEAD-IN = D" & INSERT_ENTRY_D & " x " & INSERT_ENTRY_DEPTH & " mm"
  stream.WriteLine "MANDATORY INSERT COUPON = left/middle/right D4.9/D5.1/D5.3 x 8.5 mm, all with D5.6 x 0.5 lead-in"
  stream.WriteLine "TOP M4 LOW-TEMP INSERT POCKETS = nominal D" & INSERT_HOLE_D & " x " & TOP_INSERT_POCKET_D & " deep mm for L8 insert"
