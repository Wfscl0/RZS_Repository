...
#define VCU_APP_SEND_STD(id, data) BSP_CAN0_Send_STD((id), (data))
#else
#define VCU_APP_SEND_STD(id, data) BSP_CAN1_Send_STD((id), (data))
#endif
...
static void Task_CanOut_20ms(void)
{
	...
	VCU_APP_SEND_STD((uint16_t)0x20, hcansend1.ESP_R_00);
	VCU_APP_SEND_STD((uint16_t)0x41, hcansend1.AMI_Rx);
	VCU_APP_SEND_STD((uint16_t)0x469, hcansend1.canb_epsmsg);
...
static void Task_CanOut_50ms(void)
{
	...
	VCU_APP_SEND_STD((uint16_t)0x10, hcansend1.canb_ipcrxmsg);
...
#if (VCU_ENABLE_BENCH_DEBUG != 0U)
	VCU_APP_SEND_STD((uint16_t)VCU_DBG_STATUS_ID, hcansend1.vcu_dbg_status);
	VCU_APP_SEND_STD((uint16_t)VCU_DBG_PEDAL_ECHO_ID, hcansend1.vcu_dbg_pedal_echo);
	VCU_APP_SEND_STD((uint16_t)VCU_DBG_AIR_WHEEL_ECHO_ID,
...
static void Task_CanOut_500ms(void)
{
	...
	VCU_APP_SEND_STD(0xBAU, tempdata);
	Task_CanOut_JY60_2(tempdata);
	VCU_APP_SEND_STD(0xBBU, tempdata);
	Task_CanOut_JY60_3(tempdata);
	VCU_APP_SEND_STD(0xBCU, tempdata);
}
