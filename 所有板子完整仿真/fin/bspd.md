...
- 当前 eprj2 网表中 R27/R28 已改为 5.62 kΩ/1 kΩ，形成约 0.755 V 参考；R25/R26 已改为 34.8 kΩ/10 kΩ，形成约 1.116 V 参考。相对各自精确目标的偏差约为 +0.7% 和 +0.45%，两组阈值分压均已完成设计修正，接口表仍以传感器物理目标对应的 0.75 V、1.11 V 为标称值。
