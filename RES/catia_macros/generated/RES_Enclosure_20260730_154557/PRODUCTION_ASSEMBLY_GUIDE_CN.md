...
版本：2026-07-30 R6（连续电池迷宫槽与 SMA 实心密封区版）  
材料：黑色高韧性 SLA 树脂，局部尺寸公差按 ±0.2 mm 设计  
适用嵌件：M4×外径5×长8 mm、M5×外径7×长8 mm

> R6 替代 R5。保留 R5 的 4.5/4.7 mm 上盖孔下余厚，同时把主壳体电池迷宫槽改为全部螺柱和加强筋完成后的最后一道闭环切削，彻底消除被加强筋补断的槽段；SMA 周围取消 D20 局部减薄和邻近减重格，恢复完整 4 mm 实心穿壁区。
...
| 三件壳体总体积 | 500.093 cm³ |
| 按 1.10 g/cm³ 估算质量 | 550.1 g |
| 按 0.45 元/g 估算净件价 | 247.55 元 |
| 加 20% 工艺余量 | 约 297.06 元 |
...
使用已购 NBR ID100×线径2.5 mm O 形圈，装入 3.4 mm 宽、1.9 mm 深槽；薄涂硅脂。外侧还有 2×1.5 mm 连续迷宫唇，进入主壳体 3.4×2 mm 闭环槽。主壳体槽是建模特征树中的最后一道底面切削，所有螺柱和加强筋均在它之前生成，因此不允许再出现跨槽树脂桥。8 颗 M4×8 螺钉均在 O 形圈外，盲孔不贯通电池腔。
...
- SMA-K：前壁 D10.4 mm，孔周保持完整 4 mm 壁厚，不设 D20 减薄槽，周边减重格全部避让。使用母座自带 O 形圈和防松垫；壳内螺母紧固后可在螺纹出口薄涂中性 RTV 作二级密封。SMA 上方可见的圆形凸台是独立的上盖 M4 盲孔凸台，盲底约 3.9 mm，不与 SMA 孔或电子腔形成贯通水路。
- 把手：每侧使用 71×36×1 mm 闭孔 EPDM 整面垫。把手孔是盲孔，不能钻穿壳壁。
- 肩带环：与主壳一体成形，不另开穿壁孔；R6 环中心 Z=47 mm，与更深侧裙保持净距。
...
- 电池盖外迷宫槽为完整闭环，螺柱和加强筋不再跨越、填断槽体；ID100×2.5 主 O 形圈仍作为首要密封。
- SMA 穿壁区为完整 T4 实心壁，除了 D10.4 必要通孔外无局部减薄或减重孔。
