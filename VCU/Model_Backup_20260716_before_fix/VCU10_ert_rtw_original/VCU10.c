...
uint8_T ESP_R_00[8];                   /* '<S146>/Signal Conversion' */
...
static void rate_scheduler(void)
{
   ...
   */
  (VCU10_M->Timing.TaskCounters.TID[1])++;
  if ((VCU10_M->Timing.TaskCounters.TID[1]) > 9) {/* Sample time: [0.01s, 0.0s] */
    VCU10_M->Timing.TaskCounters.TID[1] = 0;
  }

  (VCU10_M->Timing.TaskCounters.TID[2])++;
  if ((VCU10_M->Timing.TaskCounters.TID[2]) > 999) {/* Sample time: [1.0s, 0.0s] */
    VCU10_M->Timing.TaskCounters.TID[2] = 0;
  }
}
...
void VCU10_step(void)
{
  ...
  if (VCU10_M->Timing.TaskCounters.TID[2] == 0) {
    real32_T u0;
  ...
  if (VCU10_M->Timing.TaskCounters.TID[1] == 0) {
     ...
     */
    VCU10_B.airprs_sensor1 = look1_iu16lu16n16_linlcase(airprs1,
      VCU10_ConstP.pooled38, VCU10_ConstP.pooled37, 1U);

    /* DataTypeConversion: '<S14>/Data Type Conversion15' incorporates:
     *  DataTypeConversion: '<S9>/Data Type Conversion'
     *  Lookup_n-D: '<S14>/1-D Lookup Table7'
     */
    VCU10_B.airprs_sensor2 = look1_iu16lu16n16_linlcase(airprs2,
      VCU10_ConstP.pooled38, VCU10_ConstP.pooled37, 1U);
     ...
     */
    VCU10_B.apps1_01 = look1_iu16lu16n16_linlcase(apps1, VCU10_ConstP.pooled38,
      VCU10_ConstP.pooled37, 1U);

    /* Saturate: '<S14>/Saturation' */
    if (VCU10_B.apps1_01 > 1.0) {
      /* DataTypeConversion: '<S14>/Data Type Conversion' incorporates:
       *  Saturate: '<S14>/Saturation'
       */
      VCU10_B.apps1_01 = 1.0;
    }
     ...
     *  Lookup_n-D: '<S14>/1-D Lookup Table9'
     */
    VCU10_B.apps2_01 = look1_iu16lu16n16_linlcase(apps2, VCU10_ConstP.pooled38,
      VCU10_ConstP.pooled37, 1U);

    /* Saturate: '<S14>/Saturation1' */
    if (VCU10_B.apps2_01 > 1.0) {
      /* DataTypeConversion: '<S14>/Data Type Conversion2' incorporates:
       *  Saturate: '<S14>/Saturation1'
       */
      VCU10_B.apps2_01 = 1.0;
    }
     ...
     */
    VCU10_B.res_stop = ((res_msg[0] & 1U) != 0U);

    /* SignalConversion generated from: '<S13>/res_error' */
    res_error = VCU10_B.res_stop;
    ...
    VCU10_B.res_communication = (rtb_y_hw != 0);
     ...
     */
    rtb_y_hw = VCU10_DW.res_heartbeat_start;
    ...
    if (VCU10_DW.is_active_c10_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c10_VCU10) {
       case VCU10_IN_begin_f:
        if (rtb_y_hw != VCU10_DW.res_heartbeat_start) {
       ...
       default:
        ...
        if (VCU10_DW.hbcnt > 10.0) {
          ...
          VCU10_B.res_hbcheck = 0.0;
        } else if (rtb_y_hw != VCU10_DW.res_heartbeat_start) {
          VCU10_DW.hbcnt = 0.0;
          VCU10_DW.is_c10_VCU10 = VCU10_IN_compare;
          VCU10_B.res_hbcheck = 1.0;
        } else {
     ...
     *  Inport: '<Root>/canb_ipctsmsg1'
     */
    VCU10_B.ipc_motor_torque = ((real_T)canb_ipctsmsg1[6] +
      rtb_DataTypeConversion1) - 5000.0;
     ...
     *  Sum: '<S169>/Add'
     */
    rtb_DataTypeConversion1 = (uint16_T)((uint32_T)canb_ipctsmsg1[0] + rtb_y_hf);

    /* Gain: '<S169>/Gain' */
    ipc_esp_flprs = rtb_DataTypeConversion1 * 0.01;
    ...
    for (i = 0; i < 8; i++) {
      /* Inport: '<S8>/canb_ipctsmsg2' incorporates:
       *  Inport: '<Root>/canb_ipctsmsg2'
       */
      VCU10_B.canb_ipctsmsg2_j[i] = canb_ipctsmsg2[i];
    }

    /* Outputs for Atomic SubSystem: '<S170>/Bit Shift' */
    /* DataTypeConversion: '<S170>/Data Type Conversion2' */
    VCU10_BitShift8((real_T)VCU10_B.canb_ipctsmsg2_j[0],
     ...
     */
    VCU10_B.Add = (rtb_DataTypeConversion1 + (real_T)VCU10_B.canb_ipctsmsg2_j[1])
      - 1024.0;

    /* Outputs for Atomic SubSystem: '<S170>/Bit Shift1' */
    /* S-Function (sfix_bitop): '<S170>/Bitwise AND' */
    VCU10_BitShift1_i((uint8_T)(VCU10_B.canb_ipctsmsg2_j[3] & 128), &rtb_y_eh);

    /* End of Outputs for SubSystem: '<S170>/Bit Shift1' */

    /* Outputs for Atomic SubSystem: '<S170>/Bit Shift2' */
    /* S-Function (sfix_bitop): '<S170>/Bitwise AND1' */
    VCU10_BitShift2_e((uint8_T)(VCU10_B.canb_ipctsmsg2_j[3] & 64), &rtb_y_hw);

    /* End of Outputs for SubSystem: '<S170>/Bit Shift2' */

    /* Outputs for Atomic SubSystem: '<S170>/Bit Shift3' */
    /* S-Function (sfix_bitop): '<S170>/Bitwise AND2' */
    VCU10_BitShift1((uint8_T)(VCU10_B.canb_ipctsmsg2_j[3] & 60), &rtb_y_hc1);
    ...
    VCU10_BitShift_p((uint16_T)VCU10_B.canb_ipctsmsg2_j[4], &rtb_y_hf);
    ...
    VCU10_BitShift_p((uint16_T)VCU10_B.canb_ipctsmsg2_j[6], &rtb_y_hf);
     ...
     */
    VCU10_BitShift_a((uint8_T)(rtb_y_cf != 0), &rtb_y_hc1);
    ...
    canb_ipcrxmsg[0] = (uint8_T)((uint32_T)(uint8_T)((uint32_T)
      VCU10_DW.steer_return + rtb_y_hc1) + (VCU10_B.res_stop << 2));
     ...
     */
    rtb_DataTypeConversion1 = floor(VCU10_DW.ipc_astask);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 256.0);
    }

    /* SignalConversion generated from: '<S8>/canb_ipcrxmsg' incorporates:
     *  DataTypeConversion: '<S164>/Data Type Conversion3'
     */
    canb_ipcrxmsg[1] = (uint8_T)(rtb_DataTypeConversion1 < 0.0 ? (int32_T)
      (uint8_T)-(int8_T)(uint8_T)-rtb_DataTypeConversion1 : (int32_T)(uint8_T)
      rtb_DataTypeConversion1);
     ...
     */
    rtb_xor_consequence = ((rtb_Product1 == 0.0) && (rtb_Product2 == 0.0));
     ...
     */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_g;
    VCU10_DW.previousTicks_g = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c1_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c1_VCU10) {
       case VCU10_IN_AS_Driving:
        VCU10_AS_Driving(&rtb_xor_consequence);
        break;
       ...
       case VCU10_IN_AS_Off:
        if ((!asms) && (!VCU10_DW.ebs_check) && (VCU10_DW.ts == 1.0)) {
    ...
    /* DataStoreRead: '<S3>/Data Store Read1' incorporates:
     *  DataStoreWrite: '<S3>/Data Store Write4'
     */
    VCU10_B.steering_flag = VCU10_B.steering_flag_o;

    /* DataStoreRead: '<S3>/Data Store Read3' incorporates:
     *  DataStoreWrite: '<S3>/Data Store Write2'
     */
    VCU10_B.manual_driving_flag = VCU10_B.manual_driving_flag_k;

    /* DataStoreRead: '<S3>/Data Store Read4' incorporates:
     *  DataStoreWrite: '<S3>/Data Store Write3'
     */
    VCU10_B.as_emergency_flag = VCU10_B.as_emergency_flag_e;
     ...
     *  Gain: '<S146>/Gain'
     */
    rtb_DataTypeConversion1 = floor(100.0 * VCU10_B.tarPrsReqFL);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
    }

    rtb_y_hf = (uint16_T)(rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint16_T)
                          -(int16_T)(uint16_T)-rtb_DataTypeConversion1 :
                          (int32_T)(uint16_T)rtb_DataTypeConversion1);
     ...
     *  Gain: '<S146>/Gain1'
     */
    rtb_DataTypeConversion1 = floor(100.0 * VCU10_B.tarPrsReqFR);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
    ...
    rtb_y_ej = (uint16_T)(rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint16_T)
                          -(int16_T)(uint16_T)-rtb_DataTypeConversion1 :
                          (int32_T)(uint16_T)rtb_DataTypeConversion1);
     ...
     *  Gain: '<S146>/Gain2'
     */
    rtb_DataTypeConversion1 = floor(100.0 * VCU10_B.tarPrsReqRL);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
    ...
    rtb_Add2_g = (uint16_T)(rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint16_T)
      -(int16_T)(uint16_T)-rtb_DataTypeConversion1 : (int32_T)(uint16_T)
      rtb_DataTypeConversion1);
     ...
     *  Gain: '<S146>/Gain3'
     */
    rtb_DataTypeConversion1 = floor(100.0 * VCU10_B.tarPrsReqRR);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
    ...
    rtb_Add1_a = (uint16_T)(rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint16_T)
      -(int16_T)(uint16_T)-rtb_DataTypeConversion1 : (int32_T)(uint16_T)
      rtb_DataTypeConversion1);
    ...
    VCU10_BitShift3_m((uint8_T)i, &rtb_y_cf);
    ...
    /* SignalConversion: '<S146>/Signal Conversion' incorporates:
     ...
     *  Sum: '<S146>/Add2'
     */
    ESP_R_00[0] = (uint8_T)rtb_y_hf;
    ESP_R_00[1] = (uint8_T)rtb_y_cq;
    ESP_R_00[2] = (uint8_T)(rtb_y_ej & 255);
    ESP_R_00[3] = (uint8_T)rtb_y_mj;
    ESP_R_00[4] = (uint8_T)rtb_y_mn;
    ESP_R_00[5] = (uint8_T)(rtb_Add1_a & 255);
    ESP_R_00[6] = (uint8_T)((uint32_T)rtb_y_cf + VCU10_ConstB.BitwiseAND8_o);
    ESP_R_00[7] = ((uint8_T)0U);
     ...
     */
    VCU10_BitShift4((uint16_T)ESP_T_03[0], &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_03'
     */
    VCU10_BitShift3((uint16_T)(ESP_T_03[1] & 240), &rtb_y_mn);
     ...
     *  Inport: '<Root>/ESP_T_03'
     */
    VCU10_BitShift_p((uint16_T)(ESP_T_03[1] & 15), &rtb_y_ej);
     ...
     *  Inport: '<Root>/ESP_T_03'
     */
    VCU10_BitShift4((uint16_T)ESP_T_03[3], &rtb_y_mj);
     ...
     *  Inport: '<Root>/ESP_T_03'
     */
    VCU10_BitShift3((uint16_T)(ESP_T_03[4] & 240), &rtb_y_cq);
     ...
     *  Inport: '<Root>/ESP_T_03'
     */
    VCU10_BitShift_p((uint16_T)(ESP_T_03[4] & 15), &rtb_Add2_g);
     ...
     *  Sum: '<S65>/Add'
     */
    VCU10_B.oilprs_flsensor = (real_T)(uint16_T)((uint32_T)rtb_y_hf + rtb_y_mn) *
      0.01;
     ...
     *  Sum: '<S65>/Add3'
     */
    VCU10_B.oilprs_rrsensor = (real_T)(uint16_T)((uint32_T)rtb_Add2_g +
      ESP_T_03[5]) * 0.01;
     ...
     *  Sum: '<S65>/Add1'
     */
    VCU10_B.oilprs_frsensor = (real_T)(uint16_T)((uint32_T)rtb_y_ej + ESP_T_03[2])
      * 0.01;
     ...
     *  Sum: '<S65>/Add2'
     */
    VCU10_B.oilprs_rlsensor = (real_T)(uint16_T)((uint32_T)rtb_y_mj + rtb_y_cq) *
      0.01;
    ...
    VCU10_DW.lifesig_start = ESP_T_03[6];
     ...
     */
    VCU10_BitShift2_b((uint16_T)(ESP_T_06[1] & 31), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_06'
     */
    VCU10_BitShift1_j((uint16_T)(ESP_T_06[2] & 252), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_06'
     */
    VCU10_BitShift4((uint16_T)(ESP_T_06[4] & 127), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_06'
     */
    VCU10_BitShift3((uint16_T)(ESP_T_06[5] & 240), &rtb_y_hf);
     ...
     */
    VCU10_BitShift4((uint16_T)ESP_T_07[0], &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_07'
     */
    VCU10_BitShift3((uint16_T)(ESP_T_07[1] & 240), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_07'
     */
    VCU10_BitShift_p((uint16_T)(ESP_T_07[1] & 15), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_07'
     */
    VCU10_BitShift4((uint16_T)ESP_T_07[3], &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_07'
     */
    VCU10_BitShift3((uint16_T)(ESP_T_07[4] & 240), &rtb_y_hf);
     ...
     *  Inport: '<Root>/ESP_T_07'
     */
    VCU10_BitShift_p((uint16_T)(ESP_T_07[4] & 15), &rtb_y_hf);
     ...
     */
    VCU10_B.LogicalOperator1_n = ((VCU10_B.oilprs_flsensor >= 0.848) &&
      (VCU10_B.oilprs_frsensor >= 0.848) && (VCU10_B.oilprs_rlsensor >= 0.742) &&
      (VCU10_B.oilprs_rrsensor >= 0.742));
     ...
     */
    VCU10_DW.asb_check = (ebs_driver_check && (VCU10_B.res_communication &&
      (VCU10_B.res_hbcheck != 0.0) && (VCU10_B.xorcheck != 0.0)) &&
                          ((VCU10_B.airprs_sensor1 >= 3.5) &&
      (VCU10_B.oilprs_flsensor >= 0.848) && (VCU10_B.oilprs_frsensor >= 0.848) &&
      (VCU10_B.oilprs_rlsensor >= 0.742) && (VCU10_B.oilprs_rrsensor >= 0.742)) &&
                          VCU10_DW.brkmotor_check);
    ...
    VCU10_POSITIVEEdge(VCU10_ConstB.MultiportSwitch[0], VCU10_DW.asb_check,
                       VCU10_DW.UnitDelay_DSTATE,
                       &VCU10_B.RelationalOperator1_no);
     ...
     */
    VCU10_POSITIVEEdge(VCU10_ConstB.MultiportSwitch_e[0], rtb_y_eh != 0,
    ...
    VCU10_NEGATIVEEdge(VCU10_ConstB.MultiportSwitch_e[1], rtb_y_eh != 0,
                       VCU10_DW.UnitDelay_DSTATE_e,
                       &VCU10_B.RelationalOperator1_n);
     ...
     */
    VCU10_DW.ebs_working = (ebs_driver_check && (VCU10_B.airprs_sensor1 >= 6.0));
     ...
     */
    VCU10_B.LogicalOperator2 = ((!VCU10_DW.ebs_working) &&
      (VCU10_B.airprs_sensor2 <= 5.5));
     ...
     */
    VCU10_DW.UnitDelay_DSTATE_e = (rtb_y_eh != 0);
    ...
    if (VCU10_DW.is_active_c20_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c20_VCU10) {
       ...
       case VCU10_IN_as_emergency:
        ...
        if (VCU10_B.as_emergency_flag != 1.0) {
          VCU10_DW.is_c20_VCU10 = VCU10_IN_begin_g;
        }
        break;
       ...
       case VCU10_IN_begin_g:
        ...
        if (VCU10_B.as_off_flag_p == 1.0) {
          ...
          VCU10_B.ami_process = 1U;
        } else if (VCU10_B.manual_driving_flag == 1.0) {
          ...
          VCU10_B.ami_process = 32U;
        } else if (VCU10_B.as_emergency_flag == 1.0) {
       ...
       case VCU10_IN_munual_driving:
        VCU10_B.ami_process = 2U;
        if (VCU10_B.manual_driving_flag != 1.0) {
          VCU10_DW.is_c20_VCU10 = VCU10_IN_begin_g;
        }
        break;
    ...
    VCU10_BitShift_a((uint8_T)(VCU10_B.ami_process & 127), &rtb_y_eh);
     ...
     *  Sum: '<S17>/Add1'
     */
    AMI_Rx[0] = (uint8_T)((uint32_T)rtb_y_eh + VCU10_DW.task_finish);
    AMI_Rx[1] = ((uint8_T)0U);
    AMI_Rx[2] = ((uint8_T)0U);
    AMI_Rx[3] = ((uint8_T)0U);
    AMI_Rx[4] = ((uint8_T)0U);
     ...
     *  Inport: '<Root>/AMI_Tx'
     */
    VCU10_BitShift2((uint8_T)(AMI_Tx[0] & 240), &rtb_y_eh);
     ...
     */
    VCU10_DW.inspection_flag = (rtb_y_eh == 5);
     ...
     */
    VCU10_DW.task_finish = (rtb_y_hw != 0);
     ...
     */
    VCU10_DW.astask_flag = (rtb_y_eh > 0);
  ...
  if (VCU10_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    VCU10_DW.brake_on = VCU10_B.LogicalOperator1_n;

    /* DataStoreWrite: '<Root>/Data Store Write3' */
    VCU10_DW.ebs_check = VCU10_B.LogicalOperator2;
     ...
     */
    VCU10_BitShift_p((uint16_T)canb_epssendmsg2[1], &rtb_y_hf);
     ...
     *  Sum: '<S60>/Add1'
     */
    rtb_DataTypeConversion1 = floor(5.0 * VCU10_B.Add + 1024.0);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 4.294967296E+9);
    }

    elapsedTicks_m = rtb_DataTypeConversion1 < 0.0 ? (uint32_T)-(int32_T)
     ...
     */
    elapsedTicks = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks;
    VCU10_DW.previousTicks = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c15_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c15_VCU10) {
       case VCU10_IN_EPS_Enable:
        if (VCU10_B.steering_flag == 0.0) {
          VCU10_DW.is_c15_VCU10 = VCU10_IN_EPS_Unable;
          VCU10_B.eps_cmdworkmode = 0U;
          VCU10_B.eps_cmdmiddle = 0U;
        } else if ((VCU10_DW.temporalCounter_i1_g >= 1U) &&
                   VCU10_DW.steer_return) {
       ...
       case VCU10_IN_EPS_Return:
        if (VCU10_DW.steer_zero) {
          ...
          VCU10_B.eps_cmdmiddle = 0U;
          VCU10_B.eps_cmdvelocity = VCU10_B.canb_ipctsmsg2_j[2];
        } else {
          VCU10_B.eps_cmdworkmode = 32U;
          VCU10_B.eps_cmdangle = 4U;
          VCU10_B.eps_cmdmiddle = 85U;
    ...
    if (VCU10_DW.inspection_flag) {
      rtb_DataTypeConversion1 = floor(sin(((VCU10_M->Timing.clockTick1) * 0.01))
        * 90.0);
    } else {
      rtb_DataTypeConversion1 = VCU10_B.eps_cmdangle;
    }

    /* End of Switch: '<S51>/Switch' */

    /* DataTypeConversion: '<S51>/Data Type Conversion1' */
    if (rtIsNaN(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
    }
    ...
    /* S-Function (sfix_bitop): '<S51>/Bitwise AND' */
    VCU10_BitShift5((uint16_T)(rtb_y_hf & 65280), &rtb_y_mn);
    ...
    canb_epsmsg[1] = 0U;
    canb_epsmsg[2] = 0U;
    canb_epsmsg[3] = (uint8_T)rtb_y_mn;
    canb_epsmsg[4] = rtb_y_hw;
    ...
    canb_epsmsg[7] = (uint8_T)((int8_T)((int8_T)((int8_T)((int8_T)
      (VCU10_B.eps_cmdworkmode != 0) ^ (int8_T)((uint8_T)rtb_y_mn != 0)) ^
      (int8_T)(rtb_y_hw != 0)) ^ (int8_T)(VCU10_B.eps_cmdmiddle != 0)) ^ (int8_T)
      (VCU10_B.eps_cmdvelocity != 0));
     ...
     */
    if (VCU10_DW.as_flag) {
      rtb_xor_consequence = !di8_side;
    } else {
      rtb_xor_consequence = !di8_cockpit;
    }
      ...
      switch (VCU10_DW.is_Ignition_Check_f) {
       case VCU10_IN_Check:
        if (VCU10_DW.di8_check_flag == 0.0) {
          ...
          VCU10_DW.di8_check_flag = !rtb_xor_consequence;
    ...
    rtb_xor_consequence = !run_button;
      ...
      switch (VCU10_DW.is_Ignition_Check) {
       case VCU10_IN_Check:
        if (VCU10_DW.run_check_flag == 1.0) {
          ...
          VCU10_DW.run_check_flag = !rtb_xor_consequence;
        }
        break;
     ...
     *  DataStoreRead: '<Root>/Data Store Read23'
     */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_gm;
    VCU10_DW.previousTicks_gm = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c9_VCU10 == 0U) {
      ...
      if (tsms && di8) {
        guard1 = false;
        if ((!VCU10_DW.as_flag) && (run && VCU10_DW.brake_on)) {
          VCU10_B.ts = 1.0;
          VCU10_B.ts_warning = T;
          guard1 = true;
        } else if (VCU10_DW.as_flag) {
          VCU10_B.ts = 1.0;
          guard1 = true;
        }
    ...
    /* Chart: '<S4>/Chart' */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_c;
    VCU10_DW.previousTicks_c = VCU10_M->Timing.clockTick1;
    ...
    i = ((VCU10_DW.clockTickCounter_a2 < 50) && (VCU10_DW.clockTickCounter_a2 >=
          0));
    ...
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_f;
    VCU10_DW.previousTicks_f = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c17_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c17_VCU10) {
       case VCU10_IN_begin_f:
        if ((VCU10_DW.temporalCounter_i1_ct >= 100U) && (shutdown_s ==
             shutdown_e)) {
     ...
     */
    if (VCU10_B.res_stop && VCU10_B.res_communication && VCU10_B.shutdown_flag &&
        VCU10_DW.as_flag) {
      VCU10_B.In1 = (VCU10_B.airprs_sensor2 >= 3.5);
    }
    ...
    /* Chart: '<S221>/display' */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_ag;
    VCU10_DW.previousTicks_ag = VCU10_M->Timing.clockTick1;
     ...
     */
    led_ebs_error = ((VCU10_B.airprs_sensor1 <= 1.0) || (VCU10_B.airprs_sensor2 <=
      1.0) || VCU10_B.In1 || ((VCU10_B.oilprs_flsensor <= 0.11) ||
      (VCU10_B.oilprs_frsensor <= 0.11) || (VCU10_B.oilprs_rlsensor <= 0.11) ||
      (VCU10_B.oilprs_rrsensor <= 0.11)) || rtb_xor_consequence);

    /* Chart: '<S222>/blue' incorporates:
     *  DataStoreRead: '<Root>/Data Store Read22'
     */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_av;
    VCU10_DW.previousTicks_av = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c13_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c13_VCU10) {
       case VCU10_IN_Blink:
        rtb_y_hf = 30000U;
        rtb_xor_consequence = !VCU10_DW.as_flag;
        if ((VCU10_B.as_led_blue == 0.0) || rtb_xor_consequence) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_Close;
          rtb_y_hf = 0U;
        } else if ((VCU10_B.as_led_blue == 1.0) || rtb_xor_consequence) {
       ...
       case VCU10_IN_Close:
        rtb_y_hf = 0U;
        if ((VCU10_B.as_led_blue == 1.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_On;
          rtb_y_hf = 60000U;
        } else if ((VCU10_B.as_led_blue == 2.0) && VCU10_DW.as_flag) {
       ...
       case VCU10_IN_Node:
        ...
        if ((VCU10_B.as_led_blue == 1.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_On;
          rtb_y_hf = 60000U;
        } else if ((VCU10_B.as_led_blue == 0.0) || (!VCU10_DW.as_flag)) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_Close;
        } else if ((VCU10_B.as_led_blue == 2.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_Blink;
          rtb_y_hf = 30000U;
       ...
       default:
        /* case IN_On: */
        rtb_y_hf = 60000U;
        if ((VCU10_B.as_led_blue == 2.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_Blink;
          rtb_y_hf = 30000U;
        } else if ((VCU10_B.as_led_blue == 0.0) || (!VCU10_DW.as_flag)) {
          VCU10_DW.is_c13_VCU10 = VCU10_IN_Close;
     ...
     *  DataStoreRead: '<Root>/Data Store Read22'
     */
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_a;
    VCU10_DW.previousTicks_a = VCU10_M->Timing.clockTick1;
    ...
    if (VCU10_DW.is_active_c14_VCU10 == 0U) {
      ...
      switch (VCU10_DW.is_c14_VCU10) {
       case VCU10_IN_Blink:
        rtb_y_hf = 30000U;
        rtb_xor_consequence = !VCU10_DW.as_flag;
        if ((VCU10_B.as_led_yellow == 0.0) || rtb_xor_consequence) {
          VCU10_DW.is_c14_VCU10 = VCU10_IN_Close;
          rtb_y_hf = 0U;
        } else if ((VCU10_B.as_led_yellow == 1.0) || rtb_xor_consequence) {
       ...
       case VCU10_IN_Close:
        rtb_y_hf = 0U;
        if ((VCU10_B.as_led_yellow == 1.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c14_VCU10 = VCU10_IN_On_o;
          rtb_y_hf = 60000U;
        } else if ((VCU10_B.as_led_yellow == 2.0) && VCU10_DW.as_flag) {
       ...
       case VCU10_IN_On_o:
        rtb_y_hf = 60000U;
        if ((VCU10_B.as_led_yellow == 2.0) && VCU10_DW.as_flag) {
          VCU10_DW.is_c14_VCU10 = VCU10_IN_Blink;
          rtb_y_hf = 30000U;
        } else if ((VCU10_B.as_led_yellow == 0.0) || (!VCU10_DW.as_flag)) {
          VCU10_DW.is_c14_VCU10 = VCU10_IN_Close;
          rtb_y_hf = 0U;
        }
        break;
    ...
    elapsedTicks_m = VCU10_M->Timing.clockTick1 - VCU10_DW.previousTicks_o;
    VCU10_DW.previousTicks_o = VCU10_M->Timing.clockTick1;
  ...
  if (VCU10_M->Timing.TaskCounters.TID[2] == 0) {
     ...
     *  BitConcat: '<S268>/bc7'
     */
    VCU10_Y.model_hox = (uint8_T)((uint8_T)((uint8_T)((uint8_T)((uint8_T)
      ((uint8_T)(ebs_buzzer << 1 | r2d_buzzer) << 1 | run) << 1 | di8) << 1 |
      led_imd_error) << 1 | led_bms_error) << 1 | ebs_trig);
  ...
  if (VCU10_M->Timing.TaskCounters.TID[1] == 0) {
    ...
    VCU10_BitShift3_m(VCU10_ConstB.BitwiseAND4, &rtb_y_eh);

    /* End of Outputs for SubSystem: '<S238>/Bit Shift3' */

    /* Chart: '<S240>/Pedal_Fault_Check' */
    if (fabs(VCU10_B.apps1_01 - VCU10_B.apps2_01) >= 0.1) {
    ...
    if (!(VCU10_B.pedal_error != 0.0)) {
      rtb_DataTypeConversion1 = (VCU10_B.apps1_01 + VCU10_B.apps2_01) / 2.0 *
        50.0;
    } else {
      rtb_DataTypeConversion1 = 0.0;
    }
      ...
      switch (VCU10_DW.is_c4_VCU10) {
       ...
       case VCU10_IN_Default_m:
        if (VCU10_B.manual_driving_flag == 1.0) {
          ...
          VCU10_B.motor_torque = rtb_DataTypeConversion1;
        } else if (VCU10_DW.as_flag) {
          VCU10_DW.is_c4_VCU10 = VCU10_IN_AS_Driving;

          /* Saturate: '<S237>/Saturation' */
          if (VCU10_B.ipc_motor_torque > 55.0) {
            VCU10_B.motor_torque = 55.0;
          } else if (VCU10_B.ipc_motor_torque < 0.0) {
            VCU10_B.motor_torque = 0.0;
          } else {
            VCU10_B.motor_torque = VCU10_B.ipc_motor_torque;
          }
       ...
       default:
        ...
        if (VCU10_B.manual_driving_flag == 0.0) {
          VCU10_DW.is_c4_VCU10 = VCU10_IN_Default_m;
          VCU10_B.motor_torque = 0.0;
        }
        break;
    ...
    rtb_DataTypeConversion1 = floor(VCU10_B.motor_torque);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 65536.0);
     ...
     *  DataTypeConversion: '<S238>/Data Type Conversion7'
     */
    rtb_y_cq = (uint16_T)((rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint16_T)
      -(int16_T)(uint16_T)-rtb_DataTypeConversion1 : (int32_T)(uint16_T)
      rtb_DataTypeConversion1) + 5000U);
    ...
    VCU10_BitShift5((uint16_T)(rtb_y_cq & 65280), &rtb_y_hf);
    ...
    /* S-Function (sfix_bitop): '<S238>/Bitwise AND10' */
    rtb_y_cq = (uint16_T)(rtb_y_cq & 255);

    /* DataTypeConversion: '<S238>/Data Type Conversion2' incorporates:
     *  DataStoreRead: '<Root>/Data Store Read15'
     */
    rtb_DataTypeConversion1 = floor(VCU10_DW.ts);
    if (rtIsNaN(rtb_DataTypeConversion1) || rtIsInf(rtb_DataTypeConversion1)) {
      rtb_DataTypeConversion1 = 0.0;
    } else {
      rtb_DataTypeConversion1 = fmod(rtb_DataTypeConversion1, 256.0);
    ...
    cana_motor_cmd[0] = (uint8_T)((uint32_T)(uint8_T)((uint32_T)(uint8_T)
      ...
      ((rtb_DataTypeConversion1 < 0.0 ? (int32_T)(uint8_T)-(int8_T)(uint8_T)
        -rtb_DataTypeConversion1 : (int32_T)(uint8_T)rtb_DataTypeConversion1) &
       1) + rtb_y_hw) + (uint8_T)(VCU10_ConstB.BitwiseAND2_o << 2)) + (uint8_T)
       (VCU10_ConstB.BitwiseAND3_o << 4)) + rtb_y_eh) + (uint8_T)
